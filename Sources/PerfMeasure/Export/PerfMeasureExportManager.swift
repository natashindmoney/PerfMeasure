//
//  PerfMeasureExportManager.swift
//  INDCommon
//
...
public final class PerfMeasureExportManager {
    ...
    public func exportToTemporaryDirectory() -> URL? {
        ...
        let tempDir = fileManager.temporaryDirectory
            .appendingPathComponent("PerfMeasureExport_\(Date().timeIntervalSince1970)", isDirectory: true)
    ...
    public func createShareableArchive() -> URL? {
        ...
        let archiveURL = fileManager.temporaryDirectory
            .appendingPathComponent("PerfMeasure_\(formattedTimestamp()).zip")
    ...
    private func getMeasurementsFileURL() -> URL? {
        ...
        let fileURL = documentsDir
            .appendingPathComponent("PerfMeasure", isDirectory: true)
    ...
    private func getBaselinesFileURL() -> URL? {
        let documentsDir = fileManager.urls(for: .documentDirectory, in: .userDomainMask).first
            ?? fileManager.temporaryDirectory
        let fileURL = documentsDir
            .appendingPathComponent("PerfBaselines", isDirectory: true)
