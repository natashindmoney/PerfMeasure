...
public final class BaselineStore {
    ...
    private let queue = DispatchQueue(label: "com.indmoney.perfmeasure.baseline", qos: .utility)
    ...
    private init(fileManager: FileManager = .default) {
        ...
        let perfDirectory = documentsDirectory.appendingPathComponent("PerfBaselines", isDirectory: true)
