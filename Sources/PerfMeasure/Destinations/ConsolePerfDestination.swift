...
public final class ConsolePerfDestination: BasePerfMeasureDestination {
    ...
    private let log = OSLog(subsystem: "com.indmoney.perfmeasure", category: "console")
    ...
    private func formatOutput(_ result: MeasurementResult) -> String {
        ...
        parts.append("\(icon) [PerfMeasure] \(result.category)/\(result.name)")
