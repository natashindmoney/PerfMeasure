//
//  INDProfilerAnalyticsDestination.swift
//  INDProfiler
//
...
public final class INDProfilerAnalyticsDestination: INDProfilerBaseDestination {
    ...
    override public func performRecord(_ result: MeasurementResult) {
        INDProfilerDependencies.analyticsWriter?.record(measurement: result)
    }
}
