...
public protocol INDProfilerDestination {
...
open class INDProfilerBaseDestination: INDProfilerDestination {
    ...
    public init(identifier: String, isEnabled: Bool = true, qos: DispatchQoS = .utility) {
        ...
        self.queue = DispatchQueue(
            label: "com.indmoney.indprofiler.\(identifier)",
            qos: qos
        )
    }
